...
export const textareaClasses = {
    // use Tailwind arbitrary width for 65% of the page
    base: "w-250 border-2 rounded-lg shadow-sm p-2 focus:outline-none overflow-hidden",
    // add right padding so an absolute-positioned button can sit inside the textarea
    response: "w-300 pr-14 border-2 rounded-lg shadow-sm p-2 focus:outline-none overflow-hidden",
...
export const buttonClassesX = {
    ...
    speech: "font-medium text-sm px-4.5 py-3 rounded-2xl transition-colors duration-200 ease-in-out hover:bg-red-600 text-white"
}